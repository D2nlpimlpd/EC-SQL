...
export SQLITE_SYSTEMS="${SQLITE_SYSTEMS:-boyuesql,no_semantic_templates,no_external_knowledge,no_schema_retrieval,no_repair}"
...
export RUN_DBT_BOYUESQL="${RUN_DBT_BOYUESQL:-1}"
export DBT_BOYUESQL_LIMIT="${DBT_BOYUESQL_LIMIT:-68}"
...
echo "[full-benchmark] BOYUESQL_MODELS=${BOYUESQL_MODELS}"
