...
try:
    from .sql_dictionary import (
        build_content_list as build_database_dictionary_content_list,
        build_custom_kg as build_database_dictionary_custom_kg,
        build_schema_entries as build_database_dictionary_schema_entries,
        hits_from_context as database_dictionary_hits_from_context,
        load_database_dictionary_excel as load_database_dictionary_excel,
        load_database_dictionary_json as load_database_dictionary_json,
    )
except ModuleNotFoundError:
    pass
except ImportError:
...
if "build_database_dictionary_content_list" in globals():
    __all__.extend(
        [
            "build_database_dictionary_content_list",
            "build_database_dictionary_custom_kg",
            "build_database_dictionary_schema_entries",
            "database_dictionary_hits_from_context",
            "load_database_dictionary_excel",
            "load_database_dictionary_json",
        ]
    )
